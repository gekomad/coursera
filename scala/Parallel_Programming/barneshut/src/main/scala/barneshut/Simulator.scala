...
class Simulator(val taskSupport: TaskSupport, val timeStats: TimeStatistics) {
  ...
  def updateBoundaries(a: Boundaries, b: Body): Boundaries = {
    a.maxX = if (a.maxX > b.x) a.maxX else b.x
    a.maxY = if (a.maxY > b.y) a.maxY else b.y
    a.minX = if (a.minX > b.x) b.x else a.minX
    a.minY = if (a.minY > b.x) b.x else a.minY
    a
  }

  def mergeBoundaries(a: Boundaries, b: Boundaries): Boundaries = {
    a.maxX = if (a.maxX > b.maxX) a.maxX else b.maxX
    a.maxY = if (a.maxY > b.maxY) a.maxY else b.maxY
    a.minX = if (a.minX > b.minX) b.minX else a.minX
    a.minY = if (a.minY > b.minY) b.minY else a.minY
    a
  }
